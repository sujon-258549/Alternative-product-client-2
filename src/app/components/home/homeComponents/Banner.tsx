      ...
      <div className="md:pt-28 md:px-0 px-5 md:mt-0 mt-10">
        <div className=" w-full md:w-[80%] lg:w-[70%] mx-auto pb-8 md:pb-12">
          ...
          >
            ...
            by various factors. One of the primary reasons for switching
            products is to ensure satisfaction with the quality. If the current
            product doesn,t meet expectations or if{" "}
          </p>
        </div>
        <div className="">
            ...
            >
              <div className="lg:max-w-lg">
                ...
                <p className="mt-3 text-gray-600 dark:text-gray-400 ">
                  ...
                  customers often develop loyalty towards specific brands,
                  better deals or superior products from competitors can lead to
                  a change in brand preference. Innovation drives product
                  development,.
                </p>
